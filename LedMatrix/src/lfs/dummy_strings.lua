...
"tmr.timer", "%q", ",", "=stdin", "Erro: Arquivo config.json nao encontrado!",
"RAM", "Running", "__metatable", "config", "config.json", "decode", "kv", "load_config",
"ok.flag", "ok.flag foi apagado ou renomeado.", "onerror",
"open", "pcall", "pcm.driver", "pixbuf.buf", "read", "sjson", "startup", "stdin",
"talvez file.rename('not_ok.flag','ok.flag') para restaurar", "tmrStartup",
"traceback", "websocket.client", "xpcall"
